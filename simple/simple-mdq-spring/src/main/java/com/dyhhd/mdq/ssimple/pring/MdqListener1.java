 ...
 * @author lv ning
 */
@QueueListener(queues = {"queue-1", "queue-2"})
@Component
public class MdqListener1 {

    public void listener1() {
    }

    @QueueHandler
    public void listener2(Worker worker) {
    ...
    @QueueHandler
    public void listener4(WorkerInstance<String> worker) {
        System.out.println("clz" + this.getClass().getName() + " method " + " listener4 " + worker);
    }

    @QueueListener(queues = "queue-4")
    public void listener5(String worker) {
